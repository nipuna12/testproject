...
namespace Chinook.Migrations
{
    ...
    [Migration("20240523164907_added-UserPlaylistTrack")]
    partial class addedUserPlaylistTrack
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chinook.Models.UserPlaylistTrack", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("UserPlaylistTrack", (string)null);
                });
            ...
            modelBuilder.Entity("Chinook.Models.UserPlaylistTrack", b =>
                {
                    ...
                    b.HasOne("Chinook.Models.UserPlaylist", "UserPlaylist")
                        .WithMany("UserPlaylistTracks")
                        .HasForeignKey("UserId", "PlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
